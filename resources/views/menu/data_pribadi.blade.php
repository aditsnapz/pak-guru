					...
					<div class="card-body">
						<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <input type="text" name="nuptk" class="form-control" placeholder="NUPTK" disabled>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-2 col-form-label" for="text-input">NRG</label>
		                      <div class="col-md-6">
		                        <input type="text" name="nrg" class="form-control" placeholder="NRG" disabled>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <input type="textarea" name="alamat_rumah" class="form-control" placeholder="Alamat Rumah" disabled>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <select name="pendidikan_progdi" class="form-control">
		                    ...
		                    <div class="form-group row">
		                      <label class="col-md-2 col-form-label" for="text-input">TMT GOLONGAN</label>
		                      <div class="col-md-6">
		                        <input type="text" name="tmt_golongan" class="form-control" placeholder="TMT GOLONGAN" disabled>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-4">
		                      	<div class="row">
		                      		<div class="col-md-2">
		                      			<input type="text" name="mk_lama_tahun" class="form-control" disabled>
		                      		</div>
		                      		<div class="col-md-2">
		                      			<input type="text" name="mk_lama_bulan " class="form-control" disabled>
		                      		</div>
		                      	</div>
		                      </div>
		                    </div>
		                     <div class="form-group row">
		                      ...
		                      <div class="col-md-4">
		                      	<div class="row">
		                      		<div class="col-md-2">
		                      			<input type="text" name="mk_baru_tahun" class="form-control" disabled>
		                      		</div>
		                      		<div class="col-md-2">
		                      			<input type="text" name="mk_baru_bulan " class="form-control" disabled>
		                      		</div>
		                      	</div>
		                      </div>
		                    </div>
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <input type="text" name="no_peserta_sertifikasi" class="form-control" placeholder="" disabled>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-2 col-form-label" for="text-input">Mapel Sertifikasi</label>
		                      <div class="col-md-6">
		                        <input type="text" name="mapel_sertifikasi" class="form-control" placeholder="Mapel Sertifikasi" disabled>
		                      </div>
		                    </div>
		                    <div class="form-group row">
